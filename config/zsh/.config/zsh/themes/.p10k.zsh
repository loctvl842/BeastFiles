# Generated by Powerlevel10k configuration wizard on 2024-03-08 at 14:49 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 04117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, round heads, round tails, 1 line, sparse, many icons, concise,
...
() {
  ...
  # Show only current folder name (basename)
  # Now display full path in top-right cornor of the terminal due to powerful wezterm
